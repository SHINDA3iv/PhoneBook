...
QT_MOC_LITERAL(1, 13, 15), // "searchRequested"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 4), // "text"
QT_MOC_LITERAL(4, 35, 12) // "cancelSearch"

    },
    "SearchDialog\0searchRequested\0\0text\0"
    "cancelSearch"
};
...
void SearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->searchRequested((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->cancelSearch(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchDialog::searchRequested)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SearchDialog::cancelSearch)) {
                *result = 1;
                return;
            }
        }
